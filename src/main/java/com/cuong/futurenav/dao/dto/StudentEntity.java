/*
 * Created on 17 Nov 2015 ( Time 01:09:50 )
...
public class StudentEntity implements Serializable {
    ...
    @Column(name="au_created_dt", updatable=false, insertable=false)
    private Date       auCreatedDt  ;

    @Temporal(TemporalType.TIMESTAMP)
    @Column(name="au_updated_dt", updatable=false, insertable=false)
    ...
    @Column(name="networkgroup", length=15)
    ...
    //----------------------------------------------------------------------
    @OneToMany(mappedBy="student", targetEntity=StudentLoginEntity.class, fetch = FetchType.EAGER)
    ...
    //--- DATABASE MAPPING : networkgroup ( SET ) 
